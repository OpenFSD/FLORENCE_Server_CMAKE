...
using FLORENCE::FrameworkSpace::ServerSpace::AlgorithmsSpace::ConcurrentSpace;
...
{
    this->ptr_Control_Of_Concurrent = new class Control_Of_Concurrent();
...
void thread_Concurrency(
    ...
    class Control_Of_Concurrent* prt_Control_Of_Concurrent,
...
class FLORENCE::FrameworkSpace::ServerSpace::AlgorithmsSpace::Praise0_Algorithm* get_Algorithm_Subset()
{
...
void set_Algorithm_Subset(class FLORENCE::FrameworkSpace::ServerSpace::AlgorithmsSpace::Praise0_Algorithm* value_algorithm)
{
