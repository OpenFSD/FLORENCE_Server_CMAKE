...
class FLORENCE::FrameworkSpace::ServerSpace::AlgorithmsSpace::ListenRespondSpace::Control_Of_ListenRespond* ptr_Control_Of_ListenRespond = nullptr;
...
void FLORENCE::FrameworkSpace::ServerSpace::AlgorithmsSpace::ListenRespond::thread_IO_ListenDistribute(
    ...
    class ListenRespondSpace::Control_Of_ListenRespond* ptr_Control_Of_ListenRespond,
...
)
{
    ...
    if (ptr_Control_Of_ListenRespond->getFlag_IO_ThreadState() == true)
    {
        ...
        /*
                objPtr_Control_Of_Input->select_Input_Buffer_SubSet(
                    ptr_PraiseBuffer_Subset,
                    objPtr_Input,
                    objPtr_Input->getPraiseEventId()
                );
        */
