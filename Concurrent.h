...
namespace FLORENCE::FrameworkSpace::ServerSpace::AlgorithmsSpace
{
    ...
    public:
        ...
        static void thread_Concurrency(
            ...
            class ConcurrentSpace::Control_Of_Concurrent* prt_Control_Of_Concurrent,
            ...
            class Praise0_Algorithm* ptr_Algorithm_Subset,
        ...
        class ConcurrentSpace::Control_Of_Concurrent* get_Control_Of_Concurrent();

        void set_Algorithm_Subset(class Praise0_Algorithm* value_algorithm);//TODO CLASS T

    protected:

    private:
        class ConcurrentSpace::Control_Of_Concurrent* ptr_Control_Of_Concurrent;
